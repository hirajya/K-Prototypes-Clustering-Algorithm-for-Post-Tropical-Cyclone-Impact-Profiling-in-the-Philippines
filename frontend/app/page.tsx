          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 mb-8">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                designed to improve assessment, disaster response, and
                preparedness for tropical cyclones in the Philippines. By
                combining official disaster impact data with meteorological
                information, the system transforms complex post-tropical
                cyclones reports into clear, actionable insights that support
                faster and fairer humanitarian decision-making.
              </p>
