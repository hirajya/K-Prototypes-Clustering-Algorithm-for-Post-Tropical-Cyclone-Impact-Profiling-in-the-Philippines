...
export default function ClusterPage() {
  ...
  const validateFormData = (data: FormData): boolean => {
    ...
    if (rainfall24 > 2000) {
      errors.max_24hr_rainfall = 'Daily rainfall exceeds world record (1,825mm)'
    }
    ...
    if (duration > 720) { // 30 days
      errors.duration_hrs = 'Duration exceeds typical typhoon lifespan (30 days)'
    }
    ...
    if ((totallyDamaged + partiallyDamaged) > families * 2 && families > 0) {
      errors.totally_damaged = 'Damaged houses seem disproportionate to families affected'
    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="number" name="families" value={formData.families} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.families ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="persons" value={formData.persons} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.persons ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="barangays" value={formData.barangays} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.barangays ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="number" name="dead" value={formData.dead} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.dead ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="injured_ill" value={formData.injured_ill} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.injured_ill ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="missing" value={formData.missing} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.missing ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="number" name="totally_damaged" value={formData.totally_damaged} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.totally_damaged ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="partially_damaged" value={formData.partially_damaged} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.partially_damaged ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="cost" value={formData.cost} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.cost ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input type="number" name="duration_hrs" value={formData.duration_hrs} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.duration_hrs ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <input type="number" name="max_24hr_rainfall" value={formData.max_24hr_rainfall} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.max_24hr_rainfall ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
                    ...
                    <input type="number" name="total_storm_rainfall" value={formData.total_storm_rainfall} onChange={handleInputChange}
                       className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 ${validationErrors.total_storm_rainfall ? 'border-red-500' : 'border-gray-300'}`} placeholder="0" />
                  </div>
                  <div>
